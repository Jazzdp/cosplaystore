      ...
      <>
        ...
        <div style={styles.statsSection}>
          ...
          <div style={styles.statsItem}>
            ...
            <div style={styles.statsLabel}>Available</div>
          </div>
          <div style={styles.statsItem}>
            <span style={styles.statsNumber}>
              {products.length > 0 && products.some(p => p.price) 
                ? `$${Math.min(...products.filter(p => p.price).map(p => p.price)).toFixed(2)}`
                : 'N/A'
              }
            </span>
    ...
    <div style={styles.container}>
      ...
      <div style={styles.heroSection}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.categoryTitle}>All Products</h1>
          <p style={styles.categorySubtitle}>
            Discover amazing costumes and accessories
          </p>
        </div>
      </div>
